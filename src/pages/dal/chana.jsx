...
export default function Chana() {
  return (
    <div>
      ...
      <>
        <p>
          चना एक अत्यन्त महत्वपूर्ण दलहनी फसल है जो कि कम सिंचित भूमि में भी आसानी से उगायी जा सकती है। दलहनी फसलों में चना का प्रमुख स्थान है। चना की औसत उत्पादकता लगभग 8 कु0/है0 है। जबकि प्रर्दशनों में लगभग 20-30 कु0/है0 प्राप्त हुआ है। अतः अधिक पैदावार प्राप्त करने हेतु निम्न बिन्दुओं पर विशेष ध्यान देना चाहिए:
        </p>
        <h4>
          <strong className="strongclass">उन्नत प्रजातियाँ</strong>
        </h4>
        <p>
          <strong className="strongclass">छोटे दाने वाली</strong>: पंत जी-114, डी.सी.पी.92-3, जी.एन.जी.-1581, आधार, जी.एन.जी 963
          <br />
          <strong className="strongclass">मध्यम आकार दाने वाली</strong>: पंत जी-186, पूसा-547
          <br />
          <strong className="strongclass">मोटे दाने वाली:</strong> पूसा-256
          <br />
          <strong className="strongclass">काबुली चना</strong>: पूसा-1003, पूसा-1053, पंत काबुली चना-1, जे.जी.के.-1, पंत काबुली चना 2
        </p>
        <p>
        ...
        <p>
          ...
          <br />
          दलहनी फसल होने के कारण, खेतों को मिट्टी से प्राप्त पोषक तत्वों से समृद्ध किया जाता है। प्रारंभिक दिनों में जब बीज पूरी तरह से फसलों के लिए काम नहीं करते हैं, तो फसलों के लिए 15-20 किलोग्राम पोषक तत्व प्रति हेक्टेयर अलग से डालना आवश्यक होता है। मिट्टी परीक्षण के माध्यम से फॉस्फेट और पोटाश के तत्वों को मिट्टी पर लागू करना लाभकारी हो सकता है। यदि मिट्टी परीक्षण नहीं किया गया हो, तो 40-45 किलोग्राम फॉस्फेट और 20-30 किलोग्राम पोटाश प्रति हेक्टेयर लागू करें। बुवाई से पहले सभी तत्वों को मिट्टी में मिला दें.
        </p>
        <p>
        ...
        <p>
          ...
          <br />
          बुवाई के 25-30 और 45-50 दिन बाद खुरपी द्वारा खरपतवारों को निकाल देना चाहिए। सभी नवीन फसलों के लिए वेल्लोर 32 ईसी (पेंडिमेथालिन 30 ईसी) और बेस्टकी किकर 2 ईसी का 1.0 किग्रा 200-250 लीटर पानी में घोलकर बुवाई के तुरंत बाद प्रति हेक्टेयर छिड़काव से खरपतवारों का प्रकोप कम हो जाता है। लंबी पत्तियों वाली खरपतवारों की संख्या अधिक होने की स्थिति में फेनोक्सीप्रोप-पी इथाइल 50 ग्राम सक्रिय तत्व 200-250 लीटर पानी में घोलकर बुवाई के 20-25 दिन बाद प्रति हेक्टेयर छिड़काव करने पर प्रभावी पाया गया है। आपके कृषि कार्यों के लिए शुभकामनाएं! यदि आपको और किसी चीज़ में सहायता चाहिए, तो बेझिझक पूछें.
        </p>
        <p>
          <strong className="strongclass">फसल सुरक्षा</strong>
        </p>
        <div style={{ float: "right" }}>
          <a style={{ fontSize: "small" }} href="Link.do?method=keetnaasak">कीटनाशक हेतु जानकारियां</a>
        </div>
        <p>
          <strong className="strongclass">कीट नियंत्रण</strong>
          <br />
          चने में मुख्य रूप से दो प्रकार के कीड़े हानि पहुंचाते हैं। कटुआ अथवा कर्तनकीट तथा फलीवेधक। कटुआ की रोकथाम के लिए फेनवैलेरेट अथवा मैथाइल पैराथियान धूल 20-25 किलोग्राम प्रति हैक्टर की दर से भूमि में मिला दें। फली बेधक के नियंत्रण के लिए नीम सीड करनेल एक्स्ट्रैक्ट 5 प्रतिशत, एन.पी.वी. 250 सूड़ीतुल्यांक अथवा बी.टी. 1 कि.ग्रा./है, मोनोक्रोटोफास 36 एस.एल के 750 मिली प्रति हैक्टर या प्रोफेनोफास 1.5 लीटर 500-600 ली. पानी में घोल कर प्रति हैक्टर छिड़काव करें। पहला छिड़काव पौधों में 50 प्रतिशत फूल आने की अवस्था में, दूसरा छिड़काव पहले के 15 दिन बाद तथा तीसरा आवश्यकतानुसार दूसरे छिड़काव के 15 दिन बाद करें.
        </p>
        <p>
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td>
                <center>
                  <strong className="strongclass1">चने का एस्कोकाइटा ब्लाइट रोग</strong>
                </center>
              </td>
              <td>
                <center>
